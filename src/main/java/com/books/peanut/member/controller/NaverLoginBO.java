...
public class NaverLoginBO {
    ...
    private final static String CLIENT_ID = "whtrMYSRx1IUM5BHnpiT"; // 클라이언트 아이디
    private final static String CLIENT_SECRET = "epJastwAhg"; // 클라이언트 시크릿
    private final static String REDIRECT_URI = "http://127.0.0.1:7777/callbackNaver.do";
