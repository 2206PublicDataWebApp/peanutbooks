				...
				<hr>
					...
					<ul class="mainUl">
			    		<li class="mainLi"><div style="text-align:right">
					    		<a href="/notice/list.kh">전체공지사항<br></a>
					    	</div>
					    </li>
					    <li class="mainLi">
			    		...
			    		<li class="mainLi">
			    			<div style="text-align:center">
					    		<a href="/notice/list.kh?status=Y">노출</a>
					    	</div>
						</li>
						<li class="mainLi">
					    	<div class="col"><img src="/resources/img/sidebar.png"></div>
			    		...
			    		<li class="mainLi">
			    			<div style="text-align:center">
					    		<a href="/notice/list.kh?status=N">비노출</a>
					    	</div>
						</li>
			 		</ul>
				<hr>
		...
		<!-- 리스트 출력 -->
			<div class="row row-cols-1">
				<table align="center" class="table col-7">
					<!-- 카테고리별 리스트 시작 -->
					<tr>
						<td class="col-7" style="border:none;" colspan="4" align="right">
