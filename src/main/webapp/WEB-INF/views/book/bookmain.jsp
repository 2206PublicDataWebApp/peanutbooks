		...
		<section>
			<article class="container" id="fisrt-article">
				<div id="info-article" class="row">
					...
					<div class="info-area col-md-6">
						<div id="title">멋진 제목</div>
						<div id="wirter-text">작가 : 일용자</div>
						<div class="tag">
							#겁많은 사람은 출입금지<br> #흥미진진한<br> #해피엔딩 기다리는
						</div>
			...
			<article class="container">
				<div class="info-title">
					...
					<div class="sub-info">설명설명설명설명설명설설명명설명
						설명설명설명설명설명설설명명설명설명설명설명설명설명설설명명설명설명설명설명설명설명설설명명설명
						설명설명설명설명설명설설명명설명설명설명설명설명설명설설명명설명설명설명설명설명설명설설명명설명
						설명설명설명설명설명설설명명설명설명설명설명설명설명설설명명설명설명설명설명설명설명설설명명설명</div>
				</div>
			...
			<article class="container" id="reply-area">
				...
				<div id="reply">
					<div class="sub-title">독자 감상(5)</div>
					<div class="reply">
								...
								<div class="card p-3">
									...
									<div class="d-flex justify-content-between align-items-center">
										...
										<div class="user d-flex flex-row align-items-center">
											<span class="col-3 d-inline-block text-truncate"><small
												class="font-weight-bold username">사용자이름 길면 잘림</small></span> <span
												class="col-11"><small class="font-weight-bold">저는
													이 책이 매우 마음에 들어요! cool</small></span>
						...
						<div class="container mt-3 view-relply">
							<div class="row">
								<div class="col-md-11 col-9">
									<textarea name="" id="reply-text" rows="3"></textarea>
								</div>
								<div class="col-md-1 col-3 reply-button-area">
									<button id="reply-button">등록</button>
								</div>
