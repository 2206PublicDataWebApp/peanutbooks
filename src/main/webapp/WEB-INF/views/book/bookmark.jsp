                ...
                <section class="container">
                    <article id="bookmark-haed-area">
                        ...
                        <div id="bookmark-search-area" class="row">
                            <div class="col-md-3" id="gubun">
                                ...
                                <!-- 종류별 출력 -->
                                <a href="/book/mybooks.do">
                                    <c:if test="${category == 'all' || category == '' || category == none}">
                                        <b>
                                    </c:if>
                                            전체
                                        </b>
                                ...
                                <div class="wrap">
                                    ...
                                    <form action="/book/mybooks.do" method="get">
                                        <div class="search">
                                            ...
                                            <input type="text" class="searchTerm" name="searchValue"
                                                placeholder="제목을 입력하세요" value="${searchValue}">
                    ...
                    <article id="booklist-area">
                        <div class="row" id="list-firstline">
                            ...
                            <div class="col-md-3">
                                <a
                                    href="/book/mybooks.do?category=${category }&step=all&searchValue=${searchValue}">등록순</a>
                                |
                                <a
                                    href="/book/mybooks.do?category=${category }&step=star&searchValue=${searchValue}">별점순</a>
                                |
                                <a
                                    href="/book/mybooks.do?category=${category }&step=view&searchValue=${searchValue}">조회순</a>
                            </div>
                        ...
                        <div id="book-list" class="row">
                            ...
                            <c:forEach items="${lList }" var="library">
                                ...
                                <c:if test="${library.bookTitle != null}">
                                    ...
                                    <div class="col-md-3 col-6" id="one-book-area" <c:if
                                        test="${library.category == 'origin'}">
                    ...
                    <article id="page-area">
                        <ul id="pagination">
                            ...
                            <c:if test="${startNavi ne 1 && startNavi > 0}">
                                <li><a
                                        href="/book/mybooks.do?category=${category }&step=${step }&searchValue=${searchValue}&category=${category }&page=${startNavi-1}">
                                        «</a></li>
                            </c:if>
                            ...
                            <c:forEach var="p" begin="${startNavi }" end="${endNavi }">
                                ...
                                <c:if test="${currentPage != p  }">
                                    <li><a
                                            href="/book/mybooks.do?category=${category }&step=${step }&searchValue=${searchValue}&category=${category }&page=${p}">
                                            ${p }</a></li>
                                </c:if>
                            </c:forEach>
                            ...
                            <c:if test="${endNavi < maxPage }">
                                <li><a
                                        href="/book/mybooks.do?category=${category }&step=${step }&searchValue=${searchValue}&category=${category }&page=${endNavi+1}">»</a>
                                </li>
                            </c:if>
                        </ul>
